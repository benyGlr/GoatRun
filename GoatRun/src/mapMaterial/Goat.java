...
public class Goat {
	...
	public boolean goatGotToNextPlank(){
		if (realX == currentPlank.LeftXOfPlank() + Constants.DISTANCE_BETWEEN_PLANKS + Constants.WIDTH_OF_PLANK){
